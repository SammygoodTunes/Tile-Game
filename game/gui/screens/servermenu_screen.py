...
class ServerMenuScreen(Screen):
	...
	def __init__(self, window) -> None:
		...
		self.join_button = Button("Join server")
		self.create_button = Button("Create server")
	...
	def update_ui(self) -> None:
		...
		self.join_button.center_with_offset(0, 0, self.window.width, self.window.height, 0, -self.join_button.get_height())
		self.create_button.update(self.window)
		self.create_button.center_with_offset(0, 0, self.window.width, self.window.height, 0, 5)
