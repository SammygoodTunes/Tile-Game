...
class Protocol:
    ...
    SENDLCGAME_REQ = 'CANISENDLOCALGAMESTATE'
    SENDLCGAME_RES = 'YESSENDLOCALGAMESTATE'
    SENDLCGAME_EOS = 'OKGOTLOCALGAMESTATE'
    SENDGLGAME_REQ = 'CANISENDGLOBALGAMESTATE'
    SENDGLGAME_RES = 'YESSENDGLOBALGAMESTATE'
    SENDGLGAME_EOS = 'OKGOTGLOBALGAMESTATE'
