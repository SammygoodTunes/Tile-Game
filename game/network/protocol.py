...
class Protocol:
    ...
    MAPDATA_REQ = 'MAPDATA'
    MAPDATA_RES = 'DATAMAP'
    MAPDATA_READY_RES = 'MAPREADY'
    PLAYERUPDATE_REQ = 'UPDATEME'
    PLAYERUPDATE_RES = 'MEUPDATE'
    PLAYERUPDATE_READY_RES = 'MEUPDATED'
    GAMEUPDATE_REQ = 'GAMEUPDATE'
    GAMEUPDATE_RES = 'UPDATEGAME'
    GAMEUPDATE_READY_RES = 'GAMEUPDATEREADY'
